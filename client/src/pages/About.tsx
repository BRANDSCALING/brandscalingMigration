    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-16">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">
          ...
          <span className="text-primary"> Scale Their Brands</span>
        </h1>
        <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
          Brandscaling Platform combines strategic learning, AI-powered insights, and community 
          collaboration to help entrepreneurs build successful, scalable brands from the ground up.
        </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
        <div>
          ...
          <p className="text-lg text-slate-700 mb-6">
            We believe every entrepreneur deserves access to world-class brand development education 
            and community support. Our mission is to democratize brand building by providing 
            strategic frameworks, AI-powered insights, and peer collaboration opportunities.
          </p>
      ...
      <div className="mb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            Led by experienced entrepreneurs and brand strategists who have been where you are.
          </p>
        </div>
