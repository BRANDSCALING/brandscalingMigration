...
```
Changelog:
- June 24, 2025. Hero background video integration: Added animated logo video as background and centered logo in Landing.tsx hero section with proper video format conversion and fallback branding
