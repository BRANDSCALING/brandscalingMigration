        ...
        <div className="container-brandscaling text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-body-large text-strategic-black mb-8 max-w-2xl mx-auto leading-relaxed font-medium">
              Discover your{" "}
              <span className="text-architect font-bold">
                Entrepreneurial DNA
              </span>{" "}
              and scale from idea to 9-figures using proven{" "}
              <span className="text-alchemist font-bold">methodologies</span>{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link href="/entrepreneurial-dna-quiz">
                <Button
                  size="lg"
                  className="btn-cta-gradient text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all"
                >
                  Discover Your E-DNA
              ...
              <Link href="/courses">
                <Button
                  variant="outline"
                  size="lg"
                  className="border-2 border-scale-orange text-scale-orange hover:bg-scale-orange hover:text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transition-all bg-white/95 backdrop-blur-sm"
                >
            ...
            <BrandQuote attribution="both">
              "Purpose → Profit → Purpose. Every entrepreneur is either an
              Architect or an Alchemist. Which are you?"
            </BrandQuote>
          </div>
        </div>
      </BrandSection>
        ...
        <div className="container-brandscaling">
          <div className="text-center mb-16">
            ...
            <p className="text-body text-gray-600 max-w-2xl mx-auto">
              Two distinct AI personalities, each tailored to your
              Entrepreneurial DNA type, ready to guide your scaling journey.
            </p>
          </div>
              ...
              <Card className="h-full border-architect-indigo/20 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-architect">
                        The AI Architect
                      </h3>
                      <p className="text-gray-600 font-medium">
                        Precise • Calm • Strategic
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6">
                    <Link href="/ai-agents">
                      <Button
                        variant="outline"
                        className="w-full border-architect-indigo text-architect-indigo hover:bg-architect-indigo hover:text-white"
                      >
                        Meet the Architect
                      </Button>
                    </Link>
              ...
              <Card className="h-full border-scale-orange/20 bg-white shadow-lg hover:shadow-xl transition-all duration-300">
                <CardContent className="p-8">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-alchemist">
                        The AI Alchemist
                      </h3>
                      <p className="text-gray-600 font-medium">
                  ...
                  <div className="mt-6">
                    <Link href="/ai-agents">
                      <Button
                        variant="outline"
                        className="w-full border-scale-orange text-scale-orange hover:bg-scale-orange hover:text-white"
                      >
                        Meet the Alchemist
                      </Button>
                    </Link>
        ...
        <div className="container-brandscaling">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-body-large text-gray-600 mb-8 max-w-2xl mx-auto">
              Take our scientifically-designed assessment to unlock personalized
              business strategies tailored to your unique entrepreneurial
              blueprint.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-12">
              <div className="text-left">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-strategic-black">
                    The Architect Path
                  </h3>
                </div>
                <p className="text-gray-600">
                  Systematic builders who scale through structured processes,
                  data-driven decisions, and methodical execution.
                </p>
              </div>
              <div className="text-left">
                <div className="flex items-center mb-4">
                ...
                <p className="text-gray-600">
                  Intuitive innovators who scale through creativity, personal
                  magnetism, and transformational leadership.
                </p>
              </div>
            </div>
      ...
      <BrandSection id="pricing" className="spacing-section bg-white">
        <div className="container-brandscaling">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-gray-600 max-w-2xl mx-auto">
              From first idea to 8-figure scaling. All DNA-personalized. All
              step-by-step.
            </p>
          </div>
            ...
            <Card className="border-gray-200 hover:shadow-lg transition-all duration-300 relative">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  <h3 className="text-2xl font-bold text-strategic-black mb-2">
                    Entry
                  </h3>
                  <div className="text-4xl font-bold text-strategic-black mb-2">
                    £499
                  </div>
                  <p className="text-gray-600 text-sm">
                    Perfect for idea-stage entrepreneurs
                  </p>
                </div>
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://launch-kit-uk-blueprint-sh.lovable.app",
                      "_blank",
                    )
                  }
                >
            ...
            <Card className="border-2 border-scale-orange hover:shadow-lg transition-all duration-300 relative">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    Complete scaling ecosystem + mastermind
                  </p>
                </div>
                ...
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://mastermindapplication.replit.app/",
                      "_blank",
                    )
                  }
                >
      ...
      <BrandSection className="spacing-section bg-gray-50">
        <div className="container-brandscaling">
          <div className="text-center mb-12">
            ...
            <p className="text-body text-gray-600 max-w-2xl mx-auto">
              Entrepreneurs from every stage find their breakthrough moment
              through Brandscaling's DNA-matched methodology.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Brilliant ideas trapped in your head, but nowhere in motion.",
              },
              {
                title: "Framework-Frustrated",
                desc: "Tried proven methods that didn't match your DNA.",
              },
              {
                title: "Mastermind Graduate",
                desc: "Outgrew your peers and rooms, seeking the next level.",
              },
              {
                title: "Successful-but-Stuck",
                desc: "Profitable but unsure of your next strategic move.",
              },
            ].map((card, i) => (
              <Card
                key={i}
                className="bg-white border-gray-200 hover:shadow-lg transition-all duration-300 hover:border-scale-orange/30"
              >
                <CardContent className="p-6">
                  <h3 className="text-lg font-bold text-strategic-black mb-3">
                    {card.title}
                  </h3>
        ...
        <div className="container-brandscaling text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-body-large text-white/90 mb-8 max-w-2xl mx-auto">
              Every billion-dollar business started with one entrepreneur
              discovering their true DNA and scaling accordingly. Your
              breakthrough moment starts now.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link href="/entrepreneurial-dna-quiz">
                <Button
                  size="lg"
                  variant="secondary"
                  className="bg-white text-strategic-black hover:bg-white/90 font-medium px-8 py-4 text-lg"
                >
                  Discover Your DNA
                  <Brain className="ml-2 h-5 w-5" />
                </Button>
              ...
              <Link href="/courses">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-strategic-black px-8 py-4 text-lg"
                >
                  Explore Platform
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
            ...
            <div className="mt-8 pt-8 border-t border-white/20">
              <BrandQuote attribution="both">
                "Every entrepreneur is either an Architect or an Alchemist. The
                key is knowing which you are and scaling accordingly."
              </BrandQuote>
            </div>
          </div>
        </div>
